import {Boundaries, css, toCoords, line} from './utils'
import { computeXRatio, computeYRatio } from './utils'
const HEIGHT = 40
...
export function sliderChart(root, data, DPI_WIDTH){
    ...
    function mousedown(event){
       const type = event.target.dataset.type // на чем кликнули
       const dimensions = {  //начальные данные

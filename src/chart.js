import './styles.scss'
import {toDate, isOver, line, circle, Boundaries, css, toCoords, computeYRatio, computeXRatio} from './utils'
...
export function chart(root,data){
   ...
   */
   function paint(){
      ...
      const columns = data.columns.map(col => {       // отсортированные данные по слайдеру

...
function toDate(timestamp) {
  ...
  return "".concat(shortMonth[date.getMonth()], " ").concat(date.getDate());
}
function isOver(mouse, x, length, dwidth) {
  // находится ли мышь на координатах
...
function circle(ctx, _ref2, color, radius) {
...
function Boundaries(_ref4) {
  ...
  columns.forEach(function (col) {
    ...
    for (var i = 1; i < col.length; i++) {
      //1 заменить на 2 и раскоментить верхнее
...
function sliderChart(root, data, DPI_WIDTH) {
  ...
  function mousedown(event) {
    var type = event.target.dataset.type; // на чем кликнули
    var dimensions = {
      //начальные данные
  ...
  */
  function paint() {
    ...
    var columns = data.columns.map(function (col) {
      // отсортированные данные по слайдеру
...
},{"./styles.scss":"styles.scss","./utils":"utils.js","./tooltip":"tooltip.js","./slider":"slider.js"}],"data.js":[function(require,module,exports) {
"use strict";
...
var tgChart = (0, _chart.chart)(document.getElementById('chart'), _data2.default[0]);
tgChart.init();
},{"./chart.js":"chart.js","./data":"data.js","./data.json":"data.json","./styles.scss":"styles.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
